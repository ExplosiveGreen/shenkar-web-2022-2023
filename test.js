...
html5QrCode.start({ facingMode: "environment" }, { fps: 10, qrbox: {width: screen.width * 0.85, height: screen.width * 0.85} }, onScanSuccess);
resultContainer.innerHTML = `${screen.width} x ${screen.height}`;